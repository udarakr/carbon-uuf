...
public class LogFileTailer extends Thread {
    ...
    public void addLogFileTailerListener( DebugTailerListner l )
    {
        this.listeners.add( l );
    }

    public void removeLogFileTailerListener( DebugTailerListner l )
    {
    ...
    protected void fireNewLogFileLine( String line )
    {
        ...
        {
            DebugTailerListner l = ( DebugTailerListner )i.next();
